...
//		
//		if (identifier != -1) printAccountMenu();
//		else System.out.println("[메세지] 로그인실패.");
//	}
//	
//	
//	void join() {	
...
//	void logout() {
//		
//		if (identifier == -1) System.out.println("[메시지] 로그인을 하신 후 이용하실 수 있습니다.");
//		else {
//			identifier = -1;
...
//						userManager.user[identifier].acc = new Account[tempAccCount-1];
//						
//						for (int i = 0; i < delIdx; i++) userManager.user[identifier].acc[i] = temp[i];
//						for (int i = delIdx; i < tempAccCount - 1; i++) userManager.user[identifier].acc[i] = temp[i+1];
//					}
//				}
//				userManager.user[identifier].accCount--;
//			}
...
//				}
//				else userManager.user[identifier].printAccount();
//			}   
//			else if (sel == 0) {
//				
//				logout();
