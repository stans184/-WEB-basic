...
//	
//	void printAllUser() {
//		for(int i = 0; i < userCount; i++) user[i].printAccount();
//	}
//	
//	
//	void addUser() {
...
//				if (user[i].id.equals(id)) isDuple = true;
//			}
//			
//			if (!isDuple) {
//				
...
//				for(int i = 0; i < userCount; i++) user[i] = temp[i];
//				temp = null;
//				
//				user[userCount] = new User();
//				user[userCount].id = id;
...
//				userCount++;
//			}
//			else System.out.println("[메시지] '"+ id + "'은 이미 가입된 아이디 입니다.\n");
//		}
//	}
//	
//	
...
//		int identifier = -1;
//		for (int i = 0; i < userCount; i++) {
//			if (name.equals(user[i].id)) identifier = i;			
//		}
//		
//		if(identifier == -1) {
...
//		user = new User[userCount - 1];
//		
//		for(int i = 0; i < identifier; i++) user[i] = temp[i];
//		for(int i =identifier; i < userCount-1; i++) user[i] =temp[i + 1];
//		
//		userCount--;
//	}
//}