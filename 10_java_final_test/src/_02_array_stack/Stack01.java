...
class ArrayStack {
	...
	public void push(char item) {
		...
		if (isFull()) System.out.println("Inserting fail! Array Stack is full!!");
		else { 			
			itemArray[++top] = item;
	...
	public void delete() {
		if(isEmpty()) System.out.println("Deleting fail! Array Stack is empty!!");			
		else top--;
	}
...
public class Stack01 {
	...
	public static void main(String args[]) {
		...
		int stackSize = 5;
		char deletedItem;
		var S = new ArrayStack(stackSize);
